        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Don't just take our word for it. Hear directly from our clients about their experience working with Mevan AI and the transformative results they've achieved.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="relative bg-gradient-to-br from-slate-900/80 to-slate-800/80 border border-white/10 rounded-3xl p-12 backdrop-blur-sm">
              ...
              >
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-3xl mx-auto">
                  Experience the same exceptional service and results. Let's transform your business together with our AI-powered solutions.
                </p>
