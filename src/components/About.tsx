                        ...
                        {stats.map((stat, index) => (
                            ...
                            >
                                ...
                                <div
                                    ...
                                    <div
                                        className="text-4xl font-bold bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent mb-2">
                                        {stat.value}
                                    </div>
              ...
              <span className="bg-linear-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
                Our Journey Through Time
                    ...
                    <div className="relative">
                        {/* Timeline Line */}
                        <div
                            className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-linear-to-b from-blue-500 via-purple-500 to-pink-500 hidden lg:block"></div>
                        ...
                        <div className="space-y-12">
                            {timeline.map((item, index) => (
                                ...
                                >
                                    ...
                                    {/* Center Circle */}
                                    <div
                                        className="hidden lg:flex absolute left-1/2 -translate-x-1/2 w-6 h-6 bg-linear-to-r from-blue-500 to-purple-500 rounded-full ring-4 ring-slate-950"></div>
                                </motion.div>
                            ))}
                        </div>
                    </div>
                        ...
                        {reasons.map((reason, index) => (
                            ...
                            >
                                ...
                                <div
                                    ...
                                    <div
                                        className="w-16 h-16 bg-linear-to-r from-blue-500 to-purple-500 rounded-xl flex items-center justify-center mb-6">
