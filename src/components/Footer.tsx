...
export function Footer({onNavigate}: FooterProps) {
    ...
    return (
        <footer className="relative border-t border-white/10 bg-slate-950/50 backdrop-blur-sm">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="flex items-start gap-2 text-gray-400">
                                <Phone className="w-5 h-5 shrink-0 mt-0.5 text-blue-400"/>
            ...
            <div
                className="absolute bottom-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-blue-500/50 to-transparent"></div>
        </footer>
    );
}